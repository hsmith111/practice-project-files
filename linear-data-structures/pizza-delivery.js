...
const nextToDeliver = pizzaStack.peek();
console.log(`The first pizza to deliver is ${nextToDeliver}`);

// 5. Deliver all the pizzas from the top of the stack down
for (let i = 6; i > 0; i--) {
    pizzaStack.pop();
    console.log(`Pizza #${i} was delivered!`);
}
...
try {
    ...
    console.log(e);
    console.log('There are no more pizzas to be delivered.');
}
